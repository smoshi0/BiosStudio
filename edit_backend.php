                            ...
                            <input type="hidden" name="id" value="<?= $projek["id"]; ?>">
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="prog_back" class=" form-control-label">Progres Back End</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="range" min="0" max="100" step="10" id="prog_back" name="prog_back" placeholder="Progres Back End" class="form-control" value="<?= $projek["prog_back"]; ?>">
                                        <small class="form-text text-muted">0% - 100%</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="note_back" class=" form-control-label">Note dari Back End</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="note_back" name="note_back" placeholder="Note dari Back End" class="form-control" value="<?= $projek["note_back"]; ?>">
                                        <small class="form-text text-muted">Note dari Back End</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
