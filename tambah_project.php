...
if( isset($_POST["submit"])){
    ...
    if( tambah($_POST) > 0 ){
        ...
        echo "
            <script>
                alert('Data Project Gagal Ditambahkan!');
                document.location.href = 'tambah_project.php';
            </script>
        ";
    }
}
...
<head>
    ...
    <!-- Title Page-->
    <title>Tambah Data - Bios Studio</title>
            ...
            <section class="statistic-chart">
                <div class="container">
                    <div class="row">
                        ...
                        <h3 class="title-5 m-b-35">TAMBAH DATA PROJEK</h3><HR><br>
                        <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="nama_projek" name="nama_projek" placeholder="Nama Projek" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="file" id="proposal" name="proposal" placeholder="Proposal" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="manajer" name="manajer" placeholder="Nama Manajer" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="anggota1" name="anggota1" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="anggotaaa" name="anggotaaa" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="anggotaaaaa" name="anggotaaaaa" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="number" id="np" name="np" placeholder="Nilai Projek" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="hp" name="hp" placeholder="Hasil Projek" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <input type="date" id="start_date" name="start_date" placeholder="Projek Dimulai" class="form-control textbox" onchange="cal()" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <input type="date" id="end_date" name="end_date" placeholder="Projek Berakhir" class="form-control textbox" onchange="cal()" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="jw" name="jw" placeholder="Jangka Waktu" class="form-control" required>
