                                ...
                                <table class="table table-data3 table-striped table-earning" id="example" class="display">
                                    ...
                                    <?php foreach( $projek as $row ) : ?>
                                        <tr class="tr-shadow">
                                            ...
                                            ?>
                                            <td>
                                                <a href="edit_front.php?id=<?= $row["id"]; ?>"> <button type="button" class="btn btn-warning btn-sm">Edit</button>
                                            </a>
                                                <a href="detail_front.php?id=<?= $row["id"]; ?>"> <button type="button" class="btn btn-success btn-sm">Detail</button>
                                            </a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
