...
$projek = query("SELECT * FROM user WHERE id = $id")[0];
                            ...
                            <input type="hidden" name="id" value="<?= $projek["id"]; ?>">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="username" readonly name="username" placeholder="Username" class="form-control" value="<?= $projek["username"]; ?>">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="level" class=" form-control-label">Hak Akses</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <select name="level" id="level" class="form-control" required>
                                            <option value="admin" <?php if($projek["level"] == "admin") echo 'selected="selected"'; ?> >Admin</option>
                                            <option value="analis" <?php if($projek["level"] == "analis") echo 'selected="selected"'; ?> >Sistem Analis</option>
                                            <option value="backend" <?php if($projek["level"] == "backend") echo 'selected="selected"'; ?> >Back End Programmer</option>
                                            <option value="frontend" <?php if($projek["level"] == "frontend") echo 'selected="selected"'; ?> >Front End Programmer</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
