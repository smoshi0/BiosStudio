                                ...
                                <table class="table table-data3 table-striped table-earning" id="example" class="display">
                                    ...
                                    <?php foreach( $projek as $row ) : ?>
                                        <tr class="tr-shadow">
                                            ...
                                            ?>
                                            <td>
                                                <a href="edit_analis.php?id=<?= $row["id"]; ?>"> <button type="button" class="btn btn-warning btn-sm">Edit</button>
                                            </a>
                                                <a href="detail_analis.php?id=<?= $row["id"]; ?>"> <button type="button" class="btn btn-success btn-sm">Detail</button>
                                            </a>
                                                <a href="hapus_analis.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin?');"> <button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                <?php endforeach; ?>
